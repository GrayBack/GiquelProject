...
public class mvc_View__fileTemplateInterfaceView_N890539298 extends com.mia.studio.generation.compilation.AbstractCompiledAction implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__fileTemplateInterfaceView_N890539298() {
		//Do nothing
	}

	//For internal use only
	mvc_View__fileTemplateInterfaceView_N890539298(int anyInt, java.util.List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						java.lang.String.format(
								...
								"fileTemplateInterfaceView", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''fileTemplateInterfaceView''");
...
_template_buffer.append("package com.mia.banque.view;");
...
_template_buffer.append(manager.action(current, "macroMethodesInterface"));_template_buffer.append('\n');
_template_buffer.append("}");
