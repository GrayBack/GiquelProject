...
public class mvc_View__textTemplateImport_N1342477770 extends com.mia.studio.generation.compilation.AbstractCompiledAction implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__textTemplateImport_N1342477770() {
		//Do nothing
	}

	//For internal use only
	mvc_View__textTemplateImport_N1342477770(int anyInt, java.util.List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						java.lang.String.format(
								...
								"textTemplateImport", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''textTemplateImport''");
...
_template_buffer.append(manager.action(current, "macroNomModel"));_template_buffer.append("Controler;");
_template_buffer.append('\n');
_template_buffer.append("import com.mia.banque.ui.view.I");
_template_buffer.append(manager.action(current, "macroNomModel"));_template_buffer.append("View;");
_template_buffer.append('\n');
_template_buffer.append("import com.mia.banque.model.I");
_template_buffer.append(manager.action(current, "macroNomModel"));_template_buffer.append(";");
_template_buffer.append('\n');
