...
public class mvc_View__macroMethodeImp_N818569270 extends com.mia.studio.generation.compilation.AbstractCompiledAction implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__macroMethodeImp_N818569270() {
		//Do nothing
	}

	//For internal use only
	mvc_View__macroMethodeImp_N818569270(int anyInt, java.util.List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						java.lang.String.format(
								...
								"macroMethodeImp", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''macroMethodeImp''");
