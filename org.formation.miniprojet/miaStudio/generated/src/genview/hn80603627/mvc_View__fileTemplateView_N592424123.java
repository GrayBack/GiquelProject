...
public class mvc_View__fileTemplateView_N592424123 extends com.mia.studio.generation.compilation.AbstractCompiledAction implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__fileTemplateView_N592424123() {
		//Do nothing
	}

	//For internal use only
	mvc_View__fileTemplateView_N592424123(int anyInt, java.util.List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						java.lang.String.format(
								...
								"fileTemplateView", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''fileTemplateView''");
...
_template_buffer.append(manager.action(current, "textTemplateSwt"));_template_buffer.append('\n');

_template_buffer.append(manager.action(current, "textTemplateImport"));_template_buffer.append('\n');
_template_buffer.append('\n');
...
_template_buffer.append('\n');
_template_buffer.append("	private I");
_template_buffer.append(manager.action(current, "macroNomModel"));_template_buffer.append(" model;");
_template_buffer.append('\n');
_template_buffer.append("	");
_template_buffer.append(manager.action(current, "macroButtons"));_template_buffer.append('\n');
_template_buffer.append("	");
_template_buffer.append(manager.action(current, "macroList"));_template_buffer.append("	");
_template_buffer.append('\n');
_template_buffer.append("	");
_template_buffer.append(manager.action(current, "textTemplateConstructor"));_template_buffer.append("	");
_template_buffer.append('\n');
_template_buffer.append("	");
_template_buffer.append(manager.action(current, "macroMethodeImp"));_template_buffer.append('\n');
_template_buffer.append("	");
_template_buffer.append('\n');
_template_buffer.append("}");
