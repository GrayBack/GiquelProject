...
public class mvc_View__fileTemplateInterfaceControleur_Filename_167028872 extends com.mia.studio.generation.compilation.AbstractCompiledAction implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__fileTemplateInterfaceControleur_Filename_167028872() {
		//Do nothing
	}

	//For internal use only
	mvc_View__fileTemplateInterfaceControleur_Filename_167028872(int anyInt, java.util.List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						java.lang.String.format(
								...
								"fileTemplateInterfaceControleur$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''fileTemplateInterfaceControleur$Filename''");
...
_template_buffer.append(manager.action(current, "macroNomControleur"));_template_buffer.append("Controleur.java");
