...
public class mvc_View__fileTemplateInterfaceControleur_1038857406 extends com.mia.studio.generation.compilation.AbstractCompiledAction implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__fileTemplateInterfaceControleur_1038857406() {
		//Do nothing
	}

	//For internal use only
	mvc_View__fileTemplateInterfaceControleur_1038857406(int anyInt, java.util.List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						java.lang.String.format(
								...
								"fileTemplateInterfaceControleur", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''fileTemplateInterfaceControleur''");
...
_template_buffer.append("package com.mia.banque.controler;");
_template_buffer.append('\n');
_template_buffer.append('\n');
_template_buffer.append("public interface I");
_template_buffer.append(manager.action(current, "macroNomControleur"));_template_buffer.append("Controleur {");
_template_buffer.append('\n');
_template_buffer.append("	");
_template_buffer.append('\n');
...
_template_buffer.append(manager.action(current, "macroDeclarationMethode"));_template_buffer.append('\n');
_template_buffer.append("}");
