...
public class mvc_ModelProperty__templateAttributs_N701614473 extends com.mia.studio.generation.compilation.AbstractCompiledAction implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_ModelProperty__templateAttributs_N701614473() {
		//Do nothing
	}

	//For internal use only
	mvc_ModelProperty__templateAttributs_N701614473(int anyInt, java.util.List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						java.lang.String.format(
								...
								"templateAttributs", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''templateAttributs''");
