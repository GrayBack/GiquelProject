...
public class mvc_ModelProperty__templateGetterImpl_1561669534 extends com.mia.studio.generation.compilation.AbstractCompiledAction implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_ModelProperty__templateGetterImpl_1561669534() {
		//Do nothing
	}

	//For internal use only
	mvc_ModelProperty__templateGetterImpl_1561669534(int anyInt, java.util.List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						java.lang.String.format(
								...
								"templateGetterImpl", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''templateGetterImpl''");
...
_template_buffer.append(manager.action(current, "toLowerCase"));_template_buffer.append(";");
_template_buffer.append('\n');
_template_buffer.append("	}");
_template_buffer.append('\n');
