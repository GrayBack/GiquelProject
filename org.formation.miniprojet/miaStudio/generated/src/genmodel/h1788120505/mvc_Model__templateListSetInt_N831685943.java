...
public class mvc_Model__templateListSetInt_N831685943 extends com.mia.studio.generation.compilation.AbstractCompiledAction implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__templateListSetInt_N831685943() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__templateListSetInt_N831685943(int anyInt, java.util.List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						java.lang.String.format(
								...
								"templateListSetInt", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''templateListSetInt''");
