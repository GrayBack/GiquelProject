...
public class mvc_ModelProperty__templateSetterImpl_N796492526 extends com.mia.studio.generation.compilation.AbstractCompiledAction implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_ModelProperty__templateSetterImpl_N796492526() {
		//Do nothing
	}

	//For internal use only
	mvc_ModelProperty__templateSetterImpl_N796492526(int anyInt, java.util.List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						java.lang.String.format(
								...
								"templateSetterImpl", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''templateSetterImpl''");
...
_template_buffer.append(manager.action(current, "name"));_template_buffer.append("(String s) {");
_template_buffer.append('\n');
_template_buffer.append("		this.");
_template_buffer.append(manager.action(current, "toLowerCase"));_template_buffer.append(" = s;");
_template_buffer.append('\n');
_template_buffer.append("	}");
_template_buffer.append('\n');
